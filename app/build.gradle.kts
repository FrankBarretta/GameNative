...
dependencies {
    ...
    if (localBuild) {
        implementation(files("../../JavaSteam/build/libs/javasteam-1.8.0-4-SNAPSHOT.jar"))
        implementation(files("../../JavaSteam/javasteam-depotdownloader/build/libs/javasteam-depotdownloader-1.8.0-4-SNAPSHOT.jar"))
