...
@Database(
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 12, to = 13), // Added amazon_games table with all columns
        // Note: Migration 13 → 14 is MANUAL (see Migration13To14.kt)
        // - Renamed id → product_id
        // - Added app_id as auto-generated primary key
    ]
)
@TypeConverters(
    AppConverter::class,
